...
namespace Code48Software.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,EmployeeId,Street,Postal,Province,Longitude,Latitude")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EmployeeId,Street,Postal,Province,Longitude,Latitude")] Address address)
        {
            if (ModelState.IsValid)
            {
