...
{
    public class EventTypes1Controller : Controller
    {
        ...
        // GET: EventTypes1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: EventTypes1/Create
